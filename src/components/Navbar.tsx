  ...
  return (
    ...
    >
      ...
      <nav hstack gap-x-4>
        ...
        <a class="font-bold" nav-item href="/posts" title="Blog">
         <div i-tabler:brand-blogger class="md:hidden" /> 
         <span class={`lt-md:hidden ${props.activePage === "posts" && "active"}`}>
          Blog
         </span>
        </a>

        <a class="font-bold" nav-item href="https://note.hyh.cool" title="Note">
